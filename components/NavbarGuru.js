...
const navLinks = [
  ...
  { href: "/guru/permintaan", label: "Permintaan", icon: Clock },
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/80 backdrop-blur-lg dark:border-slate-800/80 dark:bg-slate-950/80 shadow-sm">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4">
        <Link href="/guru" className="group flex items-center gap-2">
          <div className="relative flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-green-400 to-emerald-500 shadow-lg transition-transform group-hover:scale-105 overflow-hidden">
            {useLogo && !logoError ? (
